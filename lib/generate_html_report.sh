...
<body>
    <div class="container">
        ...
        <div class="footer">
            Generated by <a href="https://github.com/nephomaniac/operator-health-report" target="_blank">Operator Health Reports</a> &bull;
            <a href="https://github.com/openshift/configure-alertmanager-operator" target="_blank">CAMO</a> &bull;
            <a href="https://github.com/openshift/route-monitor-operator" target="_blank">RMO</a> &bull;
            <a href="https://github.com/openshift/osd-metrics-exporter" target="_blank">OME</a>
        </div>
    </div>
